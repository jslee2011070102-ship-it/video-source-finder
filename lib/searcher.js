...
async function searchAllChannels(keyword, keywordEn, keywordZh, imageUrl) {
  ...
  const CHANNELS = [
    ...
    { name: '小红书',       icon: '🛍️', searchUrl: `https://www.xiaohongshu.com/search_result?keyword=${zh}&type=video` },
    { name: 'Lemon8',       icon: '🍋', searchUrl: `https://www.lemon8-app.com/search?keyword=${en}` },
    { name: 'Pinterest',    icon: '📌', searchUrl: `https://www.pinterest.com/search/videos/?q=${en}` },
